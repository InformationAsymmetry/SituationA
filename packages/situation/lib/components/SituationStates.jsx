          ...
          {currentMoodboardIndex === situationState.index ? (
            <React.Fragment>
               <div className={["row"]} style={{ marginTop: "-8px" }}>
                ...
                <div className={["col-xs-1"]} onClick={e => nextMoodboard()} style={{borderBottom: "1px solid rgb(252, 173, 86)", textAlign: "center", fontSize: "60px", textAlign: "center", color: "#FCAD56", cursor: "ne-resize"}}>⇛</div>
              </div>

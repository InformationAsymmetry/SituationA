...
const theSituationHeader = () => (
  <React.Fragment>
    <h1 style={{margin: "0", padding: "30px 0px", border: "3px solid #EF3340", backgroundColor: "#198a00ff", color: "#FCAD56", borderRight: "13px solid rgb(239, 125, 0)", borderLeft: "13px solid rgb(239, 125, 0)"}}>
      ...
      <span style={{color: "rgb(239, 125, 0)", lineHeight: "34px", fontSize: "28px", padding: "0 35px", color: "rgb(239, 51, 64)", float: "right", backgroundColor: "rgb(252, 173, 86)" }}><span style={{backgroundColor: "rgb(252, 173, 86)"}}>↼ a11M</span><span style={{backgroundColor: "rgb(25, 138, 0)", color: "rgb(252, 173, 86)"}}>1N3</span>⇁</span>
...
registerComponent({ name: 'theSituationHeader', component: theSituationHeader, hocs: [ withCurrentUser ]});